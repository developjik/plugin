...
- After execute execution, before review, as an intermediate quality pass
...
- When the goal is plan verification (use `review` instead)
...
- If this was a post-implementation quality pass -> suggest transitioning to `review` for independent plan verification
