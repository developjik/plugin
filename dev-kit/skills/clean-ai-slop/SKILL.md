...
A corrective discipline for cleaning AI-generated code. Runs after code generation — whether from `execute`, a manual session, or any other source.
...
- After `execute` completes and the implementation works but reads like AI wrote it
...
- If the code was generated by `execute` → report results to the user
